...
class CapitalTab(ttk.Frame):
    def __init__(self, parent):
        ...
        self.top.pack(side="top", fill="both", expand=True, padx=5, pady=5)

        self.bottom = ttk.Frame(self)
        self.bottom.pack(side="bottom", fill="both", expand=True, padx=5, pady=5)
        ...
        self.info_label = ttk.Label(self.bottom, textvariable=self.info_text, font=('', 30))
        self.info_label.pack(side="top")

        self.capital_label_one = ttk.Label(
            self.left, textvariable=self.current_time_one, font=('', 16)
        )
        self.capital_label_one.pack()
        self.capital_label_two = ttk.Label(
            self.right, textvariable=self.current_time_two, font=('', 16)
        )
